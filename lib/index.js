    ...
    class Manager extends React.Component {
      ...
      render() {
        return (
          ...
          >
            <Transitioner {...props} component={this.state.screen_a} style={this.state.style_a} nav={nav.getPropsApi(this.state.screenName_a)} overlay_zIndex={this.state.overlay_zIndex} />
            <Transitioner {...props} component={this.state.screen_b} style={this.state.style_b} nav={nav.getPropsApi(this.state.screenName_b)} overlay_zIndex={this.state.overlay_zIndex} />
